...
@Component({
  selector: 'app-campo-visualizar-publico',
  templateUrl: './campo-visualizar-publico.component.html',
  styleUrls: ['./campo-visualizar-publico.component.scss']
})
export class VisualizarCampoPublicoComponent implements OnInit {
