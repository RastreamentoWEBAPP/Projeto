...
@Component({
  selector: 'app-lote-visualizar-publico',
  templateUrl: './lote-visualizar-publico.component.html',
  styleUrls: ['./lote-visualizar-publico.component.scss']
})
export class LoteVisualizarPublicoComponent implements OnInit {
